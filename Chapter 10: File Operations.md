...
Likewise, the **/sbin directory is intended for essential binaries related to system administration, such as fsck and ip.** To view a list of these programs.
...
6. Note you could have also done either of these two commands:
student:/tmp> patch group < patchfile
